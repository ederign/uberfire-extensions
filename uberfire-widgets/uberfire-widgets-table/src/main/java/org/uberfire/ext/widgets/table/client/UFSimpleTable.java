...
public class UFSimpleTable<T>
    ...
    protected UFColumnPicker<T> columnPicker;

    public UFSimpleTable() {
        setupDataGrid( null );
        setupGridTable();
    }

    public UFSimpleTable( final ProvidesKey<T> providesKey ) {
    ...
    protected void setupColumnPicker() {
        columnPicker = new UFColumnPicker<>( dataGrid );
    }
