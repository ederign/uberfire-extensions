...
public abstract class ResizableMovableHeader<T> extends Header<String> {
    ...
    private final ColumnPickerClientOnly columnPicker;
    private final Column<T, ?> column;

    private final Element tableElement;
    private HeaderHelper current;
    private List<ColumnChangedHandlerClientOnly> columnChangedHandlers = new ArrayList<ColumnChangedHandlerClientOnly>();

    public ResizableMovableHeader( final String title,
                                   final DataGrid<T> table,
                                   final ColumnPickerClientOnly columnPicker,
    ...
    protected void columnResized( final int newWidth ) {
        ...
        for ( ColumnChangedHandlerClientOnly handler : columnChangedHandlers ) {
