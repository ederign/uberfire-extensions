...
public class ColumnMetaClientOnly<T> implements Comparable {
    ...
    public ColumnMetaClientOnly(Column<T, ?> column,
                      String caption) {
        this.column = column;
    ...
    public ColumnMetaClientOnly(Column<T, ?> column, String caption,boolean visible, boolean extraColumn) {
    ...
    public int compareTo(Object o) {
        if (!(o instanceof ColumnMetaClientOnly)) {
            return 0;
        }
        ColumnMetaClientOnly otherMeta = (ColumnMetaClientOnly) o;
